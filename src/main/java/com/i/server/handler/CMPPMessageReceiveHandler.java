...
public class CMPPMessageReceiveHandler extends MessageReceiveHandler {
    ...
    protected ChannelFuture reponse(final ChannelHandlerContext ctx, Object msg) {
        ...
        if (msg instanceof CmppDeliverRequestMessage) {
            ...
            System.out.println("ly 接收到 CmppSubmitRequestMessage 消息");
            // EchoServer.sendSms("15655198966", "【信内】我是短信内容2", "109002");
            EchoServer.sendSms2((CmppSubmitRequestMessage) msg);
            // CmppSubmitRequestMessage e = new CmppSubmitRequestMessage();
            // e.setDestterminalId("16655169698");
            // e.setLinkID("0000");
            // e.setMsgContent("【信内】我是短信内容3");
            // e.setRegisteredDelivery((short) 1);
            // e.setMsgid(new MsgId());
            // e.setServiceId("");
            // e.setSrcId("106909009002");
            // e.setMsgsrc("109002");
